...
void equivalentLoadFromSimTwoLocalLoad(void);// эквивалентная от двух симметричных сосредоточенных нагрузок
...
// эквивалентная от двух симметричных сосредоточенных нагрузок
