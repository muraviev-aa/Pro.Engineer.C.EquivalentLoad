...
void equivalentLoadFromTriangularLoad(void); // эквивалентная от треугольной нагрузки на всей длине балки
...
\nI - треугольная нагрузка на всей длине балки,\nH - справка,\nQ - выход;\n");
...
// эквивалентная от треугольной нагрузки на всей длине балки
